...
class HybridFlowShop(Problem):
    ...
    def distribution_data(
            ...
            for stage in range(self.num_stages):
                ...
                if np.random.rand() < prob_random_duration:
                    gen = SeededPoisson(
                        ...
                        loc=loc,
                        seed=stage + job * self.num_stages,
                    )
                else:
        ...
        # store constants
        constants["num_jobs"] = self.num_jobs
        constants["num_stages"] = self.num_stages
        for stage, num_machines_stage in enumerate(self.num_machines):
