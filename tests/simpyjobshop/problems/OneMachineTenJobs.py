...
class OneMachineTenJobs(Problem):
    """
    Specific implementation of a single-machine scheduling problem.

    Implements the concrete model and distribution data generation for
